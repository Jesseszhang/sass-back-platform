...
const DropMenu = {
  ...
  methods: {
    ...
    _initMultipleSelect() {
      ...
      this.selectAllOption = this.value.length === this.optionItems.length
    ...
    _processDropItems(optionItems) {
      ...
      if (this.processDropItems) {
        ...
        let options = {}
        if (Array.isArray(this.optionItems)) {
          options = this.optionItems.slice()
        } else {
          options = Object.assign({}, this.optionItems)
        }
        
        this.optionItems = this.processDropItems.call(null, options, this);
     ...
     */
    verify() {
      this.dangerTip = this.errorTip || `请选择${this.errorMessage}${this.errorMessage ? '的' : ''}下拉框！`;
    ...
    selectAll() {
      ...
      if (this.selectAllOption) {
        ...
        this.value = Object.assign([], this.selectAllVal)
      }
