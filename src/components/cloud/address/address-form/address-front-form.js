...
export default {
  ...
  data() {
    return {
    	addressDetailUrl: apiPath.getAddressFrontDetailUrl,
      addressAddUrl: apiPath.addressFrontAddUrl,
      addressUpdateUrl: apiPath.addressFrontUpdateUrl,
      getAddressMainUrl: apiPath.addressFrontMainUrl,
    }
  }
}