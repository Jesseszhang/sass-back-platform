<div class="page-layout-bg">
  <div class="tbox-list">
    <div class="tool-stage clear-fix">
      ...
      <btn 
        flag="/page/tboxDictionary/Add"
        type="button" 
        value="+ 新增"
        primary="default"
        class="add"
        kind="default"
        v-link = "{ path: '/page/tboxDictionary/Add' }"></btn>
    </div>
          ...
          <table-cell >
            <div class="options">
              <div class="button-wrap">
                <btn 
                  flag="/page/tboxDictionary/Edit"
                  type="link" 
                  value="编辑"
                  primary="default"
                  kind="default" 
                  v-link = "{ path: '/page/tboxDictionary/Edit', query: { id: trItem.id } }"></btn>
              </div>
            </div>
          </table-cell>
        </table-row>
